export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'curecos',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Curecos',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'curecos.net',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://curecos.net',
