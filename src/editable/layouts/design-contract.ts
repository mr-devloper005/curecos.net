...
export const editableRootStyle = {
  '--slot4-page-bg': '#f6f0f5',
  '--slot4-page-text': '#251a24',
  '--slot4-panel-bg': '#efe2ee',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#705e6e',
  '--slot4-soft-muted-text': '#8c7b89',
  '--slot4-accent': '#6B3F69',
  '--slot4-accent-fill': '#6B3F69',
  '--slot4-accent-soft': '#efe2ee',
  '--slot4-on-accent': '#ffffff',
  '--slot4-dark-bg': '#2b1c2a',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#eadce8',
  '--slot4-cream': '#fffafa',
  '--slot4-warm': '#f4e9f2',
  '--slot4-lavender': '#e8d8e6',
  '--slot4-gray': '#f2edf1',
  '--slot4-body-gradient': 'linear-gradient(180deg,#fbf7fa 0%,#f6f0f5 38%,#efe2ee 100%)',
  '--editable-page-bg': '#f6f0f5',
  '--editable-page-text': '#251a24',
  '--editable-container': '1040px',
  '--editable-border': '#DDC3C3',
  '--editable-nav-bg': '#ffffff',
  '--editable-nav-text': '#251a24',
  '--editable-nav-active': '#8D5F8C',
  '--editable-nav-active-text': '#ffffff',
  '--editable-cta-bg': '#6B3F69',
  '--editable-cta-text': '#ffffff',
  '--editable-search-bg': '#ffffff',
  '--editable-footer-bg': '#6B3F69',
